...
--
-- Host: 192.168.152.137    Database: hr
-- ------------------------------------------------------
...
-- Dump completed on 2019-04-14 18:18:24

-- Relación entre employees y departments
ALTER TABLE employees
ADD CONSTRAINT fk_department
FOREIGN KEY (department_id)
REFERENCES departments(department_id);

-- Relación entre employees y jobs
ALTER TABLE employees
ADD CONSTRAINT fk_job
FOREIGN KEY (job_id)
REFERENCES jobs(job_id);

-- Relación entre departments y locations
ALTER TABLE departments
ADD CONSTRAINT fk_location
FOREIGN KEY (location_id)
REFERENCES locations(location_id);

-- Relación entre locations y countries
ALTER TABLE locations
ADD CONSTRAINT fk_country
FOREIGN KEY (country_id)
REFERENCES countries(country_id);

-- Relación entre countries y regions
ALTER TABLE countries
ADD CONSTRAINT fk_region
FOREIGN KEY (region_id)
REFERENCES regions(region_id);

-- Relación entre job_history y employee
ALTER TABLE job_history
ADD CONSTRAINT fk_emp
FOREIGN KEY (employee_id)
REFERENCES employees(employee_id);

-- Relación entre job_history y jobs
ALTER TABLE job_history
ADD CONSTRAINT fk_job_history_job
FOREIGN KEY (job_id)
REFERENCES jobs(job_id);

-- Relación entre job_history y departments
ALTER TABLE job_history
ADD CONSTRAINT fk_job_history_dept
FOREIGN KEY (department_id)
REFERENCES departments(department_id);
